...
import { COUNTRY_META, calculateAllEstimates, totalPillar1Eur, deriveAllParams } from '@/modules/pension';
...
export function StepEstimate({ state }: Props) {
  ...
  return (
    <div className="text-center py-4">
      ...
      >
        Your State Pension <span style={{ color: 'var(--gold-light)' }}>Estimate</span>
      </h1>
      ...
      <div className="mb-6">
        <div className="text-[11px] uppercase tracking-wider font-medium mb-2" style={{ color: 'var(--gold)' }}>
          Total Monthly State Pension Income
        </div>
        <div
          style={{
