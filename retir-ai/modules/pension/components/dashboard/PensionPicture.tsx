...
const guideData: Record<string, GuideInfo> = {
  ...
  'AHV/AVS Individual Account Extract': {
    ...
    steps: [
      ...
      { num: 4, text: 'Upload to RetirAI', detail: 'Upload the PDF. We\'ll replace your estimated Swiss state pension with verified figures and recalculate your scale number.' },
    ],
    tips: [
  ...
  'Vorsorgeausweis (BVG/LPP Statement)': {
    ...
    steps: [
      ...
      { num: 5, text: 'Upload to RetirAI', detail: 'Upload the statement. We\'ll add your workplace pension capital to your projection — this could significantly change your retirement picture.' },
    ],
    altPath: {
    ...
    tips: [
      ...
      'Your workplace pension capital has been earning interest since 2019 — the current value may be higher than your last statement',
      'If you find the capital, you\'ll also want to check buy-in opportunities (Einkauf) for tax optimization',
    ],
    conciergeNote: 'Locating Swiss workplace pension assets is one of the most common problems we solve. We can search zentralstelle.ch, contact the Auffangeinrichtung, and negotiate with the pension fund — all in German, on your behalf.',
  },
};
...
const steps: Step[] = [
  {
    ...
    docs: [
      ...
      },
      {
        ...
        unlocks: 'verified French contribution years', unlockColor: 'var(--amber)', flag: '🇫🇷 State pension',
      },
    ],
  },
  {
    ...
    docs: [
      { icon: '🇱🇺', name: 'Extrait de Carrière', desc: 'Issued by CNAP. Confirms all Luxembourg state pension insurance years. Available from guichet.lu.', unlocks: 'verified LU pension · +18% accuracy', unlockColor: 'var(--amber)' },
      { icon: '🇨🇭', name: 'AHV/AVS Individual Account Extract', desc: 'Issued by SVA. Shows complete Swiss state pension contribution record. Available via ahv-iv.ch.', unlocks: 'verified CH state pension · +10% accuracy', unlockColor: 'var(--amber)' },
  ...
  {
    num: 3,
    title: 'Unlock your workplace pension projections',
    color: 'var(--blue)',
    ...
    docs: [
      { icon: '🇨🇭', name: 'Vorsorgeausweis (BVG/LPP Statement)', desc: 'Shows vested benefits, projected annuity, insured salary, and buy-in options. If you left your Swiss employer, this may be in a Freizügigkeitskonto.', unlocks: 'Unlock workplace pension · could add €1,000+/mo', unlockColor: 'var(--blue)' },
    ],
  },
];
...
const completedDocs = [
  ...
  { icon: '📊', name: 'Vorsorgeausweis', source: 'Freizügigkeitsstiftung', country: '🇨🇭', date: 'Mar 2026', impact: 'Unlocked workplace pension · €210K capital · +€1,040/mo' },
...
export function PensionPicture() {
  ...
  return (
    <Card className="mb-5">
      {/* Header */}
      <div className="mb-4">
        <div className="text-[15px] font-semibold" style={{ color: 'var(--text)' }}>Documents & Manual Entry</div>
        <div className="text-xs mt-0.5" style={{ color: 'var(--text-dim)' }}>
          Upload official documents or enter data manually — each one sharpens your projection
        </div>
      </div>
