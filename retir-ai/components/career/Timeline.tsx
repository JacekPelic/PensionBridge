...
const timelineItems = [
  {
    ...
    body: 'Pillar 1 contributions estimated from salary and dates. ~6.0 insurance years.',
  ...
  },
  {
    ...
    body: 'Pillar 1 contributions estimated from salary and dates. ~5.3 insurance years.',
    status: 'estimated' as const,
  },
  {
  ...
  },
  {
    ...
    body: 'Pillar 1 contributions estimated from salary and dates. ~5.1 insurance years.',
    status: 'estimated' as const,
  },
  {
    dotColor: 'var(--green)', pill: { variant: 'green' as const, label: '🇫🇷 France' },
    ...
    body: 'Pillar 1 contributions estimated from salary and dates. ~4.7 insurance years.',
    status: 'estimated' as const,
  },
];
