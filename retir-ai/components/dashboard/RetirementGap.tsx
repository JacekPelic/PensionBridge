    ...
    <Card className="mb-5 relative overflow-hidden">
      ...
      <div className="flex items-start justify-between gap-4 flex-wrap mb-[22px]">
        <div>
          ...
          <div className="text-xs" style={{ color: 'var(--text-dim)' }}>
            {complete
              ? 'Your verified projection vs your goal — and how to close the difference'
              : 'Your projected Pillar 1 income vs your goal — Pillar 2 & 3 not yet included'}
          </div>
          {!complete && (
      ...
      <div className="mb-[22px]">
        <div className="flex justify-between items-baseline mb-2">
          <span className="text-xs uppercase tracking-wide" style={{ color: 'var(--text-muted)' }}>
            {complete ? 'Your projection' : 'Pillar 1 projection'}
          </span>
        ...
        <div className="relative h-12 rounded-[10px] overflow-hidden mb-2.5" style={{ background: 'var(--navy-3)' }}>
          ...
          {!complete && (
            ...
            <div className="absolute top-0 h-full flex items-center justify-center"
              ...
              <span className="text-[10px] font-medium" style={{ color: 'var(--amber)' }}>P2 & P3 unknown</span>
            </div>
          )}
          {/* Remaining gap */}
          <div className="absolute top-0 h-full flex items-center justify-center"
        ...
        <div className="flex justify-between items-center">
          <div className="flex items-center gap-2.5">
            ...
            <span className="text-xs" style={{ color: 'var(--text-muted)' }}>
              {complete ? 'Projected' : 'Pillar 1'} <strong style={{ color: 'var(--text)' }}>€{projected.toLocaleString()}/mo</strong>
            </span>
          </div>
          {!complete && (
            <div className="flex items-center gap-2.5">
              ...
              <span className="text-xs" style={{ color: 'var(--text-muted)' }}>P2 & P3 <strong style={{ color: 'var(--amber)' }}>unknown</strong></span>
            </div>
          )}
          <div className="flex items-center gap-2.5">
        ...
        {complete ? (
          <>
            {[
              ...
              { label: 'Pillar 3 gap', amount: '−€580', color: 'var(--red)', desc: 'No private savings currently tracked' },
          ...
          <>
            {[
              { label: 'Pillar 2 & 3', amount: '?', color: 'var(--amber)', desc: 'Upload pension statements to reveal your occupational & private savings' },
      ...
      <div className="rounded-[10px] p-3.5 px-[18px] mb-4" style={{ background: 'var(--navy-3)', border: '1px solid rgba(62,207,142,0.2)' }}>
        ...
        <div className="flex justify-between mt-1.5">
          ...
          {!complete && <span className="text-[11px]" style={{ color: 'var(--amber)' }}>P2/P3 unknown</span>}
        ...
        <div className="rounded-[10px] p-3.5 px-[18px] mb-4 flex items-center gap-3.5 flex-wrap"
          ...
          <div className="flex-1 min-w-[200px]">
            <div className="text-[13px] font-semibold mb-[3px]" style={{ color: 'var(--text)' }}>
              You also have <span style={{ color: 'var(--blue)' }}>€210,000</span> in Swiss P2 capital
            </div>
