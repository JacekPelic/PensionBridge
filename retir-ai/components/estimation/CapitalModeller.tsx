...
import { SWISS_P2_CAPITAL, DRAWDOWN_YEARS } from '@/lib/constants';
import { capitalComponents } from '@/lib/mock-data';
  ...
  return (
    <Card className="mb-5" style={{ borderColor: 'rgba(96,165,250,0.25)' }}>
      ...
      <div className="p-5 rounded-xl" style={{ background: 'var(--navy-3)', border: '1px solid rgba(96,165,250,0.2)' }}>
        <div className="text-[13px] font-semibold mb-1" style={{ color: 'var(--text)' }}>Swiss Pillar 2 Capital Modeller</div>
        <div className="text-xs mb-4" style={{ color: 'var(--text-muted)' }}>
          Slide to model how much of your Swiss P2 to take as a lump sum vs annuity
        </div>
        ...
        <div className="grid grid-cols-3 gap-3">
          ...
          <div className="p-3 rounded-lg text-center" style={{ background: 'var(--navy-4)' }}>
            ...
            <div className="text-[11px]" style={{ color: 'var(--text-dim)' }}>{capitalPct}% of P2 capital</div>
          </div>
          <div className="p-3 rounded-lg text-center" style={{ background: 'var(--navy-4)' }}>
