...
import { BASE_TMI, RETIREMENT_YEARS } from '@/lib/constants';
...
export function IncomeGoalInput({ target, onTargetChange }: Props) {
  const projected = BASE_TMI;
      ...
      <div className="flex items-start justify-between gap-5 flex-wrap">
        <div className="flex-1 min-w-[240px]">
          ...
          <div className="text-[13px] mb-3.5 max-w-[400px]" style={{ color: 'var(--text-muted)' }}>
            What monthly income do you need to maintain your current lifestyle in retirement?
          </div>
