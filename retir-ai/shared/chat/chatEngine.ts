...
const chatResponses: Record<string, ChatResponse> = {
  gap: {
    text: `Good question, Mats. I've found **2 gaps** in your imported career data:\n\n**1. Jan–Mar 2020 (3 months)**\nBetween your Swiss period (ended Dec 2019) and your Luxembourg period (started Apr 2020). Impact: **−€120/month** at retirement.\n\n**2. Q1–Q2 2008 (2 trimestres / 6 months)**\nBetween your two French employment periods. We don't have any data for this time — were you working, studying, or abroad? Two missing trimestres can be the difference between the full rate and a permanent décote at 64.\n\nThe Luxembourg gap can potentially be fixed via CNAP voluntary buy-back (~€1,200). For the French gap, we need your Relevé de Carrière to confirm whether those trimestres are recoverable.`,
